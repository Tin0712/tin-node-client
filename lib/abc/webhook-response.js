...
const logger = { debug: require('debug')('abc:abc-node')};
const {validateVerb, specs } = require('@tin0712/verb-specifications');
...
class WebhookResponse {
   ...
   * @returns function
   */
  static verifytinSignature(secret) {
    return (req, res, next) => {
      const header = req.get('abc-Signature');
